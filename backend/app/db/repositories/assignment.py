...
def section_info(section_id: str | None, db: Session) -> tuple[str | None, str | None]:
...
def list_teacher_assignments(course_id: str, teacher_id: str,
    ...
    for a in assignments:
        sid, stitle = section_info(a.section_id, db)
...
def get_teacher_assignment(course_id: str, assignment_id: str, teacher_id: str, db: Session) -> dict:
    ...
    attachment_url = file_url(a.attachment_path) if a.attachment_path else None
    return {
